...
import profile_img from "../images/hemraj.jpg.jpg";
      ...
      >
        <Stack maxW={"2xl"} align={"center"} spacing={6}>
          ...
          >
            <Typewriter
              options={{
                strings: ["I'm a Full Stack Web Developer.", "React Devolper."],
                autoStart: true,
                loop: true,
                deleteSpeed: 50,
              }}
          ...
          <Stack direction={"row"}>
            <IconButton
              as="a"
              href="https://github.com/hemraj8078saini"
              bg={"white"}
              color={"white"}
              _hover={{
                background: "#1877f2",
            ...
            <IconButton
              as="a"
              color={"black"}
              href="https://www.linkedin.com/in/hemraj-saini-862497237/"
              target="_blank"
              _hover={{
                background: "#1877f2",
                color: "black",
